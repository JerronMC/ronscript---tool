# RON SCRIPTS V5.0.0 — BIG UPDATE

- Hypernova main UI + 26 UI styles
- Animated buttons, icons, and cards
- Normal scripts are free
- VIP: Vergil x Argus
- Premium: Argus x Hidan V3.5
- Aizen and Hidan 2 are free
- Premium approval questions with Firestore real-time status
- Creator VIP admin retained
...
- Creator/Auth status refreshes VIP state automatically.
